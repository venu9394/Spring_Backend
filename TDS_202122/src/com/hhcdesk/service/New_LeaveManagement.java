...
// ********************************** User Authentication	
	...
	//	String Query=bundle_info.getString("HHCL_DESK_USER_LOGIN");
		...
		payperiod.append(" TRANSACTIONDURATION IN (SELECT MAX(TRANSACTIONDURATION) FROM HCLADM_PROD.TBL_TRANSACTION_DATES where businessunitid=11) AND TRANSACTIONTYPEID=1 ");
