     ...
     Res=null;
		...
		if(Routing.equalsIgnoreCase("Att_Request")  && User_Auth==1){
			...
			try{	
				...
				ps=conn.prepareStatement("INSERT INTO hclhrm_prod_others.tbl_emp_attn_req (EMPLOYEEID,SUBJECT,REQ_DATE,MESSAGE,RANDOMID,FROM_DATE,TO_DATE,TOTA_HOURS,TO_EMAIL,CC_EMAIL,HR_CC_MAIL,EMPMAIL,Mail_status) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,'N')");
