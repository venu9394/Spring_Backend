...
public class Attendance_3334_assam extends HttpServlet {

	public Attendance_3334_assam() {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		JSONObject TOTDEDD = new JSONObject();
	...
	try{
		...
		Assam_exday=Integer.parseInt(bundle_info.getString("Assam_exday"));
	}catch(Exception erd){
...
if(ATT_FLAG!=null && ATT_FLAG.equalsIgnoreCase("DATES")){
	...
	if(EmpBuid.equalsIgnoreCase("16") || EmpBuid.equalsIgnoreCase("15") || EmpBuid.equalsIgnoreCase("33") || EmpBuid.equalsIgnoreCase("34") ){
  ...
  //if(Month!=null && Month.equalsIgnoreCase("currmonth")  ){
		...
		if(ATT_FLAG!=null && ATT_FLAG.equalsIgnoreCase("MONTHS")){
			...
			Emp_DOJ.append(" select A.DATEON AS DAY ,A.ATT_IN AS FIN,A.ATT_OUT AS FOUT, A.NET_HOURS AS PERDAY , ifnull(D.FLAG,'NA') AS ATT_FLAG ,  ");
			Emp_DOJ.append(" if(A.DATEON=ifnull(C.LEAVEON,'0000-00-00'),C.LEAVE_TYPE, A.DAYTYPE) AS DAYTYPE, ");
			Emp_DOJ.append(" IF(A.DATEON=ifnull(C.LEAVEON,'0000-00-00'),if(C.Manager_status='A','Approved','Pending'), ");
			Emp_DOJ.append(" IF( ");
			Emp_DOJ.append(" ifnull(D.FLAG,'No Request')='A','Approved', ");
			Emp_DOJ.append(" if(ifnull(D.FLAG,'No Request')='R','Reject', ");
			Emp_DOJ.append(" if(ifnull(D.FLAG,'No Request')='P','Processed','No Request' ");
			Emp_DOJ.append(" )))) STATUS, ");
			Emp_DOJ.append(" D.FLAG, ");
			Emp_DOJ.append(" if(A.DATEON=ifnull(C.LEAVEON,'0000-00-00'), ");
			Emp_DOJ.append(" concat(C.LEAVE_TYPE,' / ',C.LEAVE_COUNT,' DAY') ");
			Emp_DOJ.append(" , A.DAYTYPE) AS DAYTYPE2, ");
			Emp_DOJ.append(" ifnull(A.SHIFT,'General') AS SHIFT, ");
			Emp_DOJ.append(" CASE ");
			Emp_DOJ.append(" WHEN A.SHIFT='Morning Shift' THEN   TIMEDIFF(A.NET_HOURS,'08:00:00') ");
			Emp_DOJ.append(" WHEN A.SHIFT='Second Shift'  THEN   TIMEDIFF(A.NET_HOURS,'08:00:00') ");
			Emp_DOJ.append(" WHEN A.SHIFT='Night Shift'   THEN   TIMEDIFF(A.NET_HOURS,'08:00:00') ");
			Emp_DOJ.append(" WHEN A.SHIFT='General'       THEN   TIMEDIFF(A.NET_HOURS,'09:00:00') ");
			Emp_DOJ.append(" WHEN A.SHIFT  in ('evening Shift','Evening Shift','Ev')  THEN   TIMEDIFF(A.NET_HOURS,'12:00:00') ");
			Emp_DOJ.append(" ELSE concat('#',TIMEDIFF(A.NET_HOURS,'09:00:00')) ");
			Emp_DOJ.append(" END AS DIFFHOURS, ");
			Emp_DOJ.append(" CASE ");
			Emp_DOJ.append(" when  ");
			Emp_DOJ.append(" A.SHIFT!='Night Shift'   && ");
			Emp_DOJ.append(" A.SHIFT!='Morning Shift' && ");
			Emp_DOJ.append(" A.SHIFT!='First Shift'   && ");
			Emp_DOJ.append(" A.SHIFT!='Second Shift'  && ");
			Emp_DOJ.append(" A.att_in!='00:00:00'     && ");
			Emp_DOJ.append(" A.SHIFT not in ('evening Shift','Evening Shift','Ev')            && ");
			Emp_DOJ.append(" A.att_in!=A.att_out      && ");
			Emp_DOJ.append(" ifnull(c.half_day,'NA')  NOT IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN  ");
		
		
			Emp_DOJ.append(" if(A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 09:01:00') && A.att_in!=A.att_out,0.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 09:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 09:16:00') && A.att_in!=A.att_out ,'0.5', ");
			Emp_DOJ.append(" if( A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 09:16:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 09:31:00') && A.att_in!=A.att_out,1.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 09:31:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 10:01:00') && A.att_in!=A.att_out,2.0,4.0) ");
			Emp_DOJ.append(" ))) ");
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.SHIFT!='Night Shift'    && ");
			Emp_DOJ.append(" A.SHIFT!='Morning Shift'  && ");
			...
			Emp_DOJ.append(" A.att_in!=A.att_out       && ");
			Emp_DOJ.append(" A.SHIFT not in ('evening Shift','Evening Shift','Ev')         && ");
			Emp_DOJ.append(" ifnull(c.half_day,'NA')   IN ('1st Half') ");
			Emp_DOJ.append(" THEN ");
			
			
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00')))>='04:00:00' && A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 14:01:00') && A.att_in!=A.att_out,0.0, ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00')))>='04:00:00' && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 14:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 14:16:00') && A.att_in!=A.att_out ,'0.5', ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00')))>='04:00:00' && A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 14:16:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 14:31:00') && A.att_in!=A.att_out,1.0, ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00')))>='04:00:00' && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 14:31:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 14:01:00') && A.att_in!=A.att_out,2.0,4.0) ");
			...
			Emp_DOJ.append(" A.att_in!=A.att_out        && ");
			Emp_DOJ.append(" A.SHIFT not in ('evening Shift','Evening Shift','Ev')             && ");
			Emp_DOJ.append(" ifnull(c.half_day,'NA')    IN ('2nd Half') ");
			Emp_DOJ.append(" THEN ");
			
			
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 09:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 09:00:00')))>='04:00:00' && A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 09:01:00') && A.att_in!=A.att_out,0.0, ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 09:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 09:00:00')))>='04:00:00'  && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 09:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 09:16:00') && A.att_in!=A.att_out ,'0.5', ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 09:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 09:00:00')))>='04:00:00'  && A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 09:16:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 09:31:00') && A.att_in!=A.att_out,1.0, ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 09:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 09:00:00')))>='04:00:00' && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 09:31:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 10:01:00') && A.att_in!=A.att_out,2.0,4.0) ");
			...
			Emp_DOJ.append(" ifnull(c.half_day,'NA')     NOT IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN ");
			Emp_DOJ.append(" if(A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 06:01:00') && A.att_in!=A.att_out ,'0.0', ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 06:01:00') && ");
			Emp_DOJ.append(" A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 06:16:00') && ");
			Emp_DOJ.append(" A.att_in!=A.att_out  ,'0.5', ");
			Emp_DOJ.append(" if(A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 06:16:00') && ");
			Emp_DOJ.append(" A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 06:31:00') && ");
			Emp_DOJ.append(" A.att_in!=A.att_out ,'1.0', ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 06:31:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 07:01:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out,'2.0','4.0'))  ");
			Emp_DOJ.append(" )) ");
			
			
			
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.SHIFT='Morning Shift' || A.SHIFT='First Shift' && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA') IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN  ");
			Emp_DOJ.append(" IF(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00')), ");
			Emp_DOJ.append(" IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 06:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 06:00:00')))>='04:00:00','0.0','4.0')");
			
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.SHIFT='Second Shift'  && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA') IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN  ");
			Emp_DOJ.append(" IF(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 22:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 22:00:00')), ");
			Emp_DOJ.append(" IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 14:00:00')))>='04:00:00','0.0','4.0')");
			
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.SHIFT='Night Shift' && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA') IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN  ");
			Emp_DOJ.append(" IF(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon + interval 1 day,'%Y-%m-%d 06:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon + interval 1 day,'%Y-%m-%d 06:00:00')), ");
			Emp_DOJ.append(" IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 22:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 22:00:00')))>='04:00:00','0.0','4.0')");
			
			
			Emp_DOJ.append(" WHEN  ");
			Emp_DOJ.append(" A.SHIFT='Second Shift' && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA') NOT IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN ");
			Emp_DOJ.append(" if(A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 14:01:00') && A.att_in!=A.att_out ,0.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 14:01:00') && ");
			Emp_DOJ.append(" A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 14:16:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out  ,'0.5', ");
			Emp_DOJ.append(" if(A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 14:16:00') ");
			Emp_DOJ.append(" && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 14:31:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out ,1.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 14:31:00') ");
			Emp_DOJ.append(" && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 15:01:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out ,2.0,4.0)))) ");
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.SHIFT='Night Shift' && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA') NOT IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN ");
			Emp_DOJ.append(" if(A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 22:01:00') && A.att_in!=A.att_out ,0.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 22:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 22:16:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out  ,'0.5', ");
			Emp_DOJ.append(" if(A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 22:16:00') ");
			Emp_DOJ.append(" && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 22:31:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out ,1.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 22:31:00') ");
			Emp_DOJ.append(" && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 23:01:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out ,2.0,4.0)))) ");
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.SHIFT  in ('evening Shift','Evening Shift','Ev') && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA') NOT IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN ");
			Emp_DOJ.append(" if(A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 18:01:00') && A.att_in!=A.att_out ,0.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 18:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 18:16:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out  ,'0.5', ");
			Emp_DOJ.append(" if(A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 18:16:00') ");
			Emp_DOJ.append(" && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 18:31:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out ,1.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 18:31:00') ");
			Emp_DOJ.append(" && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 18:01:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out ,2.0,4.0)))) ");
			Emp_DOJ.append(" WHEN ");
			
			Emp_DOJ.append(" A.SHIFT in ('evening Shift','Evening Shift','Ev') && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA')  IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN ");
			
			Emp_DOJ.append(" IF(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon + interval 1 day,'%Y-%m-%d 06:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon + interval 1 day,'%Y-%m-%d 06:00:00')), ");
			Emp_DOJ.append(" IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 18:00:00')))>='04:00:00','0.0','4.0')");
		
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.att_in!='00:00:00' AND A.att_in=A.att_out ");
			Emp_DOJ.append(" THEN ");
			Emp_DOJ.append(" '4.0' ");
			
			Emp_DOJ.append(" WHEN  ");
			Emp_DOJ.append(" A.att_in='00:00:00' AND A.att_out='00:00:00' ");
			Emp_DOJ.append(" THEN ");
			Emp_DOJ.append(" '0.0' ");
			
			Emp_DOJ.append(" ELSE  ");
			Emp_DOJ.append(" '0.0' ");
			Emp_DOJ.append(" END AS DEDHOURS_NET, ");
			Emp_DOJ.append(" CASE   ");
			Emp_DOJ.append(" WHEN A.SHIFT='Morning Shift' THEN    IF(TIMEDIFF(A.NET_HOURS,'08:00:00')<'00:00:00','true',  'false') ");
			Emp_DOJ.append(" WHEN A.SHIFT='Second Shift'  THEN    IF(TIMEDIFF(A.NET_HOURS,'08:00:00')<'00:00:00','true',  'false') ");
			Emp_DOJ.append(" WHEN A.SHIFT='Night Shift'   THEN    IF(TIMEDIFF(A.NET_HOURS,'08:00:00')<'00:00:00','true',  'false') ");
			Emp_DOJ.append(" WHEN A.SHIFT='General'       THEN    IF(TIMEDIFF(A.NET_HOURS,'09:00:00')<'00:00:00','true',  'false') ");
			Emp_DOJ.append(" WHEN A.SHIFT  in ('evening Shift','Evening Shift','Ev')           THEN    IF(TIMEDIFF(A.NET_HOURS,'12:00:00')<'00:00:00','true',  'false') ");
			Emp_DOJ.append(" ELSE  IF(TIMEDIFF(A.NET_HOURS,'09:00:00')<'00:00:00','true','false')  END AS DEDHOURS , ");
			Emp_DOJ.append(" date_format(A.DATEON,'%d-%m-%Y') AS DAYVIEW , date_format(now(),'%d-%m-%Y') As Newdate , date_format(now() + interval -"+Assam_exday+" DAY,'%d-%m-%Y') As Newdate1 , ");
			Emp_DOJ.append(" xx.DED_EV_HOURS , ");
			Emp_DOJ.append(" if(ifnull(c.half_day,'NA')  NOT IN ('1st Half','2nd Half') , xx.DED_EV_HOURS,'0.0') AS DED_EV_HOURS, ");
			Emp_DOJ.append(" if(ifnull(c.half_day,'NA')  NOT IN ('1st Half','2nd Half') , ");
			Emp_DOJ.append(" if(abs(xx.DED_EV_HOURS)<'01:00:00' and xx.DED_EV_HOURS<'00:00:00' ,'1.0', ");
			Emp_DOJ.append(" concat(HOUR(xx.DED_EV_HOURS),'.',MINUTE(xx.DED_EV_HOURS))),'0.0' ");
			Emp_DOJ.append(" ) AS END_DED_HR ");
			Emp_DOJ.append(" from test_mum.tbl_att_leave_in_out_status_report A ");
			Emp_DOJ.append(" join hclhrm_prod.tbl_employee_primary pr on pr.employeesequenceno=A.employeeid and A.PAYPERIOD=0 ");
			Emp_DOJ.append(" left join hclhrm_prod_others.tbl_emp_leave_report C ON C.employeeid=pr.employeesequenceno ");
			Emp_DOJ.append(" AND ifnull(C.LEAVEON,'0000-00-00')=A.DATEON AND C.MANAGER_STATUS IN ('A','P') ");
			Emp_DOJ.append(" and C.STATUS=1001 ");
			Emp_DOJ.append(" left join hclhrm_prod_others.tbl_emp_attn_req D ON D.EMPLOYEEID=pr.employeesequenceno ");
			Emp_DOJ.append(" AND D.REQ_DATE=A.DATEON AND  D.REQ_TYPE='AR' AND D.STATUS=1001 ");
			Emp_DOJ.append(" left join ( ");
			Emp_DOJ.append(" select dateon, 	 ");
			Emp_DOJ.append(" if(ATT_OUT=ATT_IN AND ATT_IN!='00:00:00' , '00:00:00', ");
			Emp_DOJ.append(" if(ifnull(SHIFT,'General')='General',IF(ACT_OUT<DATE_FORMAT(dateon,'%Y-%m-%d 18:00:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon,'%Y-%m-%d 18:00:00')),'00:00:000'), ");
			Emp_DOJ.append(" if(SHIFT='Morning Shift',IF(ACT_OUT<DATE_FORMAT(dateon,'%Y-%m-%d 14:00:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon,'%Y-%m-%d 14:00:00')),'00:00:000'), ");
			Emp_DOJ.append(" if(SHIFT='Second Shift',IF(ACT_OUT<DATE_FORMAT(dateon,'%Y-%m-%d 22:00:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon,'%Y-%m-%d 22:00:00')),'00:00:000'), ");
			Emp_DOJ.append(" if(SHIFT='Night Shift',IF(ACT_OUT < DATE_FORMAT(dateon + interval 1 day ,'%Y-%m-%d 06:00:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon + interval 1 day,'%Y-%m-%d 06:00:00')),'00:00:000'), 	 ");
			Emp_DOJ.append(" if(SHIFT in ('evening Shift','Evening Shift','Ev'),IF(ACT_OUT < DATE_FORMAT(dateon + interval 1 day ,'%Y-%m-%d 06:00:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon + interval 1 day,'%Y-%m-%d 06:00:00')),'00:00:000'),'00:00:00' 	 ");
			Emp_DOJ.append(" )))))) DED_EV_HOURS ");
			
			Emp_DOJ.append(" from 	test_mum.tbl_att_leave_in_out_status_report where employeeid="+username+" ");
			Emp_DOJ.append(" and dateon  between CONCAT(YEAR(NOW()),'-"+Month+"','-01') and LAST_DAY(CONCAT(YEAR(NOW()),'-"+Month+"','-01')) ");
			Emp_DOJ.append(" ) xx on xx.dateon=A.dateon ");
			Emp_DOJ.append(" where pr.employeesequenceno in("+username+") ");
			Emp_DOJ.append(" and a.dateon between  CONCAT(YEAR(NOW()),'-"+Month+"','-01') and LAST_DAY(CONCAT(YEAR(NOW()),'-"+Month+"','-01')) ");
			Emp_DOJ.append(" order by a.dateon "); 
		...
		/*	Emp_DOJ.append(" select A.DATEON AS DAY ,A.ATT_IN AS FIN,A.ATT_OUT AS FOUT, A.NET_HOURS AS PERDAY, ifnull(D.FLAG,'NA') AS ATT_FLAG ,");
			...
			Emp_DOJ.append(" WHEN A.SHIFT='Second Shift'  THEN   TIMEDIFF(A.NET_HOURS,'08:00:00') ");
			Emp_DOJ.append(" WHEN A.SHIFT='Night Shift'   THEN   TIMEDIFF(A.NET_HOURS,'08:00:00') ");
			Emp_DOJ.append(" WHEN A.SHIFT='General'       THEN   TIMEDIFF(A.NET_HOURS,'09:30:00') ");
			Emp_DOJ.append(" WHEN A.SHIFT='Ev'  THEN   TIMEDIFF(A.NET_HOURS,'12:00:00') ");
			Emp_DOJ.append(" ELSE concat('#',TIMEDIFF(A.NET_HOURS,'09:30:00')) ");
			Emp_DOJ.append(" END AS DIFFHOURS, ");
			Emp_DOJ.append(" CASE ");
			Emp_DOJ.append(" when  ");
			Emp_DOJ.append(" A.SHIFT!='Night Shift'   && ");
			...
			Emp_DOJ.append(" A.SHIFT!='Second Shift'  && ");
			Emp_DOJ.append(" A.att_in!='00:00:00'     && ");
			Emp_DOJ.append(" A.SHIFT!='Ev'            && ");
			Emp_DOJ.append(" A.att_in!=A.att_out      && ");
			Emp_DOJ.append(" ifnull(c.half_day,'NA')  NOT IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN  ");
		/*	Emp_DOJ.append(" if(A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 08:01:00') && A.att_in!=A.att_out,0.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 08:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 08:16:00') && A.att_in!=A.att_out ,'0.5', ");
			Emp_DOJ.append(" if( A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 08:16:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 08:31:00') && A.att_in!=A.att_out,1.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 08:31:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 09:01:00') && A.att_in!=A.att_out,2.0,4.0) ");
			Emp_DOJ.append(" ))) ");
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.SHIFT!='Night Shift'    && ");
			Emp_DOJ.append(" A.SHIFT!='Morning Shift'  && ");
		...
		/*	Emp_DOJ.append(" if(A.NET_HOURS>='04:00:00' && A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 14:01:00') && A.att_in!=A.att_out,0.0, ");
			Emp_DOJ.append(" if(A.NET_HOURS>='04:00:00' && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 14:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 14:16:00') && A.att_in!=A.att_out ,'0.5', ");
			Emp_DOJ.append(" if(A.NET_HOURS>='04:00:00' && A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 14:16:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 14:31:00') && A.att_in!=A.att_out,1.0, ");
			Emp_DOJ.append(" if(A.NET_HOURS>='04:00:00' && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 14:31:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 14:01:00') && A.att_in!=A.att_out,2.0,4.0) ");
		*/	//asdas
		/*	Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 17:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 17:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00')))>='04:00:00' && A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 13:01:00') && A.att_in!=A.att_out,0.0, ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 17:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 17:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00')))>='04:00:00' && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 13:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 13:16:00') && A.att_in!=A.att_out ,'0.5', ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 17:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 17:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00')))>='04:00:00' && A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 13:16:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 13:31:00') && A.att_in!=A.att_out,1.0, ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 17:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 17:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 13:00:00')))>='04:00:00' && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 13:31:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 13:01:00') && A.att_in!=A.att_out,2.0,4.0) ");
		...
		//	asas
			...
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 12:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 12:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 09:30:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 09:30:00')))>='04:00:00' && A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 08:01:00') && A.att_in!=A.att_out,0.0, ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 12:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 12:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 09:30:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 09:30:00')))>='04:00:00'  && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 08:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 08:16:00') && A.att_in!=A.att_out ,'0.5', ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 12:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 12:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 09:30:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 09:30:00')))>='04:00:00'  && A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 08:16:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 08:31:00') && A.att_in!=A.att_out,1.0, ");
			Emp_DOJ.append(" if(TIMEDIFF(IF(A.ACT_OUT<DATE_FORMAT(A.dateon,'%Y-%m-%d 12:00:00'),A.ACT_OUT,DATE_FORMAT(A.dateon,'%Y-%m-%d 12:00:00')),IF(A.ACT_IN>DATE_FORMAT(A.dateon,'%Y-%m-%d 09:30:00'),A.ACT_IN,DATE_FORMAT(A.dateon,'%Y-%m-%d 09:30:00')))>='04:00:00' && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 08:31:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 09:01:00') && A.att_in!=A.att_out,2.0,4.0) ");
			
			
		/*	Emp_DOJ.append(" if( A.NET_HOURS>='04:00:00' && A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 09:01:00') && A.att_in!=A.att_out,0.0, ");
			Emp_DOJ.append(" if(A.NET_HOURS>='04:00:00'  && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 09:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 09:16:00') && A.att_in!=A.att_out ,'0.5', ");
			Emp_DOJ.append(" if(A.NET_HOURS>='04:00:00'  && A.ACT_IN>=DATE_FORMAT(a.dateon,'%Y-%m-%d 09:16:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 09:31:00') && A.att_in!=A.att_out,1.0, ");
			Emp_DOJ.append(" if( A.NET_HOURS>='04:00:00' && A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 09:31:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 10:01:00') && A.att_in!=A.att_out,2.0,4.0) ");
			*/
		/*	Emp_DOJ.append(" ))) ");
			Emp_DOJ.append(" WHEN  ");
			Emp_DOJ.append(" A.SHIFT='Morning Shift'     && ");
			...
			//Emp_DOJ.append(" IF(A.NET_HOURS>='04:00:00','0.0',4.0) ");
		/*	Emp_DOJ.append(" WHEN  ");
			Emp_DOJ.append(" A.SHIFT='Second Shift' && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA') NOT IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN ");
			Emp_DOJ.append(" if(A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 14:01:00') && A.att_in!=A.att_out ,0.0, ");
			...
			Emp_DOJ.append(" && A.att_in!=A.att_out ,2.0,4.0)))) ");
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.SHIFT='Ev' && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA') NOT IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN ");
			Emp_DOJ.append(" if(A.ACT_IN<=DATE_FORMAT(a.dateon,'%Y-%m-%d 18:01:00') && A.att_in!=A.att_out ,0.0, ");
			Emp_DOJ.append(" if(A.ACT_IN>DATE_FORMAT(a.dateon,'%Y-%m-%d 18:01:00') && A.ACT_IN<DATE_FORMAT(a.dateon,'%Y-%m-%d 18:16:00') ");
			Emp_DOJ.append(" && A.att_in!=A.att_out  ,'0.5', ");
			...
			Emp_DOJ.append(" && A.att_in!=A.att_out ,2.0,4.0)))) ");
			Emp_DOJ.append(" WHEN ");
			Emp_DOJ.append(" A.SHIFT='Ev' && A.att_in!='00:00:00' && A.att_in!=A.att_out && ifnull(c.half_day,'NA')  IN ('1st Half','2nd Half') ");
			Emp_DOJ.append(" THEN ");
			...
			Emp_DOJ.append(" WHEN A.SHIFT='Second Shift'  THEN    IF(TIMEDIFF(A.NET_HOURS,'08:00:00')<'00:00:00','true',  'false') ");
			Emp_DOJ.append(" WHEN A.SHIFT='Night Shift'   THEN    IF(TIMEDIFF(A.NET_HOURS,'08:00:00')<'00:00:00','true',  'false') ");
			Emp_DOJ.append(" WHEN A.SHIFT='General'       THEN    IF(TIMEDIFF(A.NET_HOURS,'09:30:00')<'00:00:00','true',  'false') ");
			Emp_DOJ.append(" WHEN A.SHIFT='Ev'            THEN    IF(TIMEDIFF(A.NET_HOURS,'12:00:00')<'00:00:00','true',  'false') ");
			Emp_DOJ.append(" ELSE  IF(TIMEDIFF(A.NET_HOURS,'09:30:00')<'00:00:00','true','false')  END AS DEDHOURS , ");
			Emp_DOJ.append(" date_format(A.DATEON,'%d-%m-%Y') AS DAYVIEW , date_format(now(),'%d-%m-%Y') As Newdate  , date_format(now() + interval -"+Assam_exday+" DAY,'%d-%m-%Y') As Newdate1 ,");
			Emp_DOJ.append(" xx.DED_EV_HOURS, ");
			Emp_DOJ.append(" if(ifnull(c.half_day,'NA')  NOT IN ('1st Half','2nd Half'),xx.DED_EV_HOURS,'0.0') AS DED_EV_HOURS, ");
			Emp_DOJ.append(" if(ifnull(c.half_day,'NA')  NOT IN ('1st Half','2nd Half'), ");
			...
			Emp_DOJ.append(" left join ( ");
			Emp_DOJ.append(" select dateon, 	 ");
			Emp_DOJ.append(" if(ATT_OUT=ATT_IN OR ATT_IN='00:00:00' , '00:00:00', ");
			Emp_DOJ.append(" if(ifnull(SHIFT,'General')='General',IF(ACT_OUT<DATE_FORMAT(dateon,'%Y-%m-%d 17:30:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon,'%Y-%m-%d 17:30:00')),'00:00:000'), ");
			Emp_DOJ.append(" if(SHIFT='Morning Shift',IF(ACT_OUT<DATE_FORMAT(dateon,'%Y-%m-%d 14:00:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon,'%Y-%m-%d 14:00:00')),'00:00:000'), ");
			Emp_DOJ.append(" if(SHIFT='Second Shift',IF(ACT_OUT<DATE_FORMAT(dateon,'%Y-%m-%d 22:00:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon,'%Y-%m-%d 22:00:00')),'00:00:000'), ");
			Emp_DOJ.append(" if(SHIFT='Night Shift',IF(ACT_OUT < DATE_FORMAT(dateon + interval 1 day ,'%Y-%m-%d 06:00:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon + interval 1 day,'%Y-%m-%d 06:00:00')),'00:00:000'), 	 ");
			Emp_DOJ.append(" if(SHIFT='Ev',IF(ACT_OUT < DATE_FORMAT(dateon + interval 1 day ,'%Y-%m-%d 06:00:00'), ");
			Emp_DOJ.append(" TIMEDIFF(ACT_OUT,DATE_FORMAT(dateon + interval 1 day,'%Y-%m-%d 06:00:00')),'00:00:000'),'00:00:00' 	 ");
			Emp_DOJ.append(" )))))) DED_EV_HOURS ");
          ...
          */			
			...
			Emp_DOJ.append(" from 	test_mum.tbl_att_leave_in_out_status_report where employeeid="+username+" ");
			Emp_DOJ.append(" and dateon  between '"+UserMap.get("FROMDATE")+"' and '"+UserMap.get("TODATE")+"' ");
			Emp_DOJ.append(" ) xx on xx.dateon=A.dateon ");
			Emp_DOJ.append(" where pr.employeesequenceno in("+username+") ");
			Emp_DOJ.append(" and a.dateon between  '"+UserMap.get("FROMDATE")+"' and '"+UserMap.get("TODATE")+"' ");
			Emp_DOJ.append(" order by a.dateon ");
		...
		System.out.println("Emp_DOJ:2"+Emp_DOJ.toString());
	...
	/*	HLDAYLIST.append("SELECT DISTINCT DATE_FORMAT(A.HOLIDAYDATE,'%d-%m-%Y') DAY,");
		...
		*/
		...
		Req_Adj.append(" AND TRANSACTIONDATE BETWEEN '"+UserMap.get("FROMDATE")+"'  AND '"+UserMap.get("TODATE")+"' ");
...
Res=null;
		...
		try {
			...
			while(Res.next()){
				UserMap.put(Res.getString(2), Res.getString(2));
...
/*	
  ...
  Months_ATT.append("	SELECT DISTINCT IF(MONTH(DATEON)<10,CONCAT(0,MONTH(DATEON)),MONTH(DATEON))MONTHS, ");
    		Months_ATT.append(" MONTHNAME(DATEON) MONTHNAME  ");
    		Months_ATT.append(" FROM test_mum.tbl_att_leave_in_out_status_report where ");
    		Months_ATT.append(" 	MONTH(DATEON)!=MONTH(CURDATE()) AND  ");
    		Months_ATT.append(" 	employeeid="+username+" AND YEAR(DATEON)=YEAR(CURDATE()) ");
    		Months_ATT.append(" ORDER BY MONTH(DATEON) DESC ");
...
if(Routing.equalsIgnoreCase("Att_Request")  && User_Auth==1){
		...
		if(User_Auth==1 && !Routing.equalsIgnoreCase("Att_Request") ){
            ...
            TOTDEDD.put("TOTAL_DD_HOURS" ,  "0.0 Hr");
			try {
				...
				while(Res.next()){
					...
					//	Doj.put("DEDHOURS_NET",Res.getString("DEDHOURS_NET")+"/"+Res.getString("DED_EV_HOURS")+"/"+Res.getString("END_DED_HR"));
						
						Doj.put("DEDHOURS_NET",Res.getString("DEDHOURS_NET"));
						Doj.put("DEDHOURS_NET_FINAL",0);
						//DED_EV_HOURS

                     ///END_DED_HR
						
						double  DEDHOURS_NET=0.00;
						double  DEDHOURS_OUT=0.00;
						double  DEDHOURS_IN=0.00;
						 ...
						 boolean inoutflg_half=false;
						  try{
							  ...
							  if(Res.getString("SHIFT")!=null && Res.getString("SHIFT").equalsIgnoreCase("Morning Shift")){
									    if(DEDHOURS_NET>8.0 || DEDHOURS_NET>08.00 ){
									    	DEDHOURS_NET=8.0;
									    }
										 ...
										 // in ('evening Shift,','Evening Shift','Ev')
										 ...
										 if(DEDHOURS_NET>12.0 || DEDHOURS_NET>12.00 ){
										    	DEDHOURS_NET=12.0;
										    }
									 }else{
										   if(DEDHOURS_NET>9.00 || DEDHOURS_NET>09.00 ){
										    	DEDHOURS_NET=9.00;
										    }
									 }
							  ...
							  if(Res.getString("DAYVIEW").toString().equalsIgnoreCase(""+Res.getString("Newdate").toString()+"")
								  ...
								  Doj.put("DEDHOURS_NET",0.0);
								  DEDHOURS_NET=0.0;
								  //DEDHOURS_IN=0.0;
							  }
							  
						     TotalNetDed_hours=TotalNetDed_hours+DEDHOURS_NET;
						  }catch(Exception ers){
						 ...
						 if(DEDHOURS_NET>0){
							 ...
							 inoutflg=true;
							 /*if(DEDHOURS_IN==0.5 && DEDHOURS_OUT<=0.00 && looHalfHourCount<=2){
								 inoutflg=false;
								 looHalfHourCount=looHalfHourCount+1;
							 }else{
								 inoutflg=true;
							 }*/
						 ...
						 if(DEDHOURS_IN<=0.5 && DEDHOURS_IN>0.0 && DEDHOURS_OUT<=0.00 && looHalfHourCount<=2){
							 inoutflg_half=true;
							 looHalfHourCount=looHalfHourCount+1;
							 if(TotalNetDed_hours>=DEDHOURS_IN){
							   TotalNetDed_hours=TotalNetDed_hours-DEDHOURS_IN;
							 }
							 Doj.put("ROCOLOR" , "");
						 }else{
							 inoutflg_half=false;
						 ...
						 Doj.put("DEDHOURS_NET",""+DEDHOURS_NET+"");
						
					try{
						
						/* if(DEDHOURS_NET>0){
						   Doj.put("LESSHOURS",Res.getString("DIFFHOURS").replace("#", "") +"/"+Res.getString("DEDHOURS_NET") +"Hrs");
						 }else{
							 Doj.put("LESSHOURS",Res.getString("DIFFHOURS").replace("#", "") +"/"+Res.getString("DEDHOURS_NET") +"Hrs");
						 }*/
						
						//Doj.put("LESSHOURS",Res.getString("DIFFHOURS").replace("#", "") +"/(LATE HOURS-)"+Res.getString("DEDHOURS_NET"));
...
*/						
                    ...
                    Doj.put("TOTAL_DD_HOURS" , decimalFormat .format(TotalNetDed_hours));
                    
                    Doj.put("ROCOLOR" , "");
                   
                    //TOTDEDD.put("TOTAL_DD_HOURS" , TotalNetDed_hours +" Hr");
					} // STOP
				...
				//MasterData.put("TOTAL", TOTDEDD);
				//MasterData.put("ATT", values);
	...
	//	MasterData
		...
		System.out.println("_SUCCESS_PAGE::"+_SUCCESS_PAGE);
		 ...
		 System.out.println("TotalNetDed_hours ::" +TotalNetDed_hours);
		if(Routing.equalsIgnoreCase("Att_Request")){
			...
			System.out.println("MasterData.toString()::"+values.toString());
			...
			request.getRequestDispatcher("HHCL_ATTENDANCE_ASSAM_3334.jsp").forward(request, response);  
		}
	}  
