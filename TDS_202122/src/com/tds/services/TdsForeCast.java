...
public class TdsForeCast {
	...
	public static void myCode_FillData(String proposedMonths, Map basic, Map TaxException, ArrayList taxempids, ArrayList empids, Map finalComponents, Map TaxSections,String PathCode){
		...
		try {
			...
			//String Sub_FilePath="C:/TDS_FORECAST/"+PathCode+"/";
			...
			//Sub_FilePath=Sub_FilePath.concat("HETERO");
			
			//Sub_FilePath=Sub_FilePath.concat("GENEX");
		...
		//	System.out.println( ft.format(dNow) );
			...
			//*******************************************************************************************
				/*
			  p = new Paragraph(new Phrase(lineSpacing,"\t	Standard Deduction", font));
...
//***************************************
				...
				//***********************************Above Sum
				double Paid_$= Double.parseDouble(TaxException.get(empid+"_CA_M").toString()) + Double.parseDouble(finalComponents.get(empid+"-Pt").toString());
				double toBePaid_$=Double.parseDouble(TaxException.get(empid+"_CA_M_y").toString())+Double.parseDouble(finalComponents.get(empid+"-ANN_Pt").toString()) ;
				...
				table.addCell(cell);
				 ...
				 // VENU REQUIRED SUM HERE
		//		p = new Paragraph(new Phrase(lineSpacing, " "+formatter.format(Double.parseDouble(finalComponents.get(empid+"-Pt").toString()))+" "   , font));
				
				p = new Paragraph(new Phrase(lineSpacing, " "+formatter.format(Paid_$)+" "   , font));
			...
			//	p = new Paragraph(new Phrase(lineSpacing, ""+formatter.format(Double.parseDouble(finalComponents.get(empid+"-ANN_Pt").toString()))+" " , font));
				p = new Paragraph(new Phrase(lineSpacing, ""+formatter.format(toBePaid_$)+" " , font));
				...
				p = new Paragraph(new Phrase(lineSpacing, " 0.00 "   , font));
				p.setAlignment(Element.ALIGN_RIGHT);
				// p.setSpacingAfter(4);
				cell1 = new PdfPCell();
				cell1.setBorder(PdfPCell.NO_BORDER);
			...
			//	p = new Paragraph(new Phrase(lineSpacing, "200000"   , font));
			...
			//	p = new Paragraph(new Phrase(lineSpacing, "200000"   , font));
				...
				p = new Paragraph(new Phrase(lineSpacing, ""+formatter.format(Double.parseDouble(TaxSections.get(empid+"S_80G_E_OL").toString()))+""   , font));
				p.setAlignment(Element.ALIGN_RIGHT);
				// p.setSpacingAfter(4);
				cell1 = new PdfPCell();
				cell1.setBorder(PdfPCell.NO_BORDER);
				...
				*/
				...
				//***************************************	
				//********************************************
				p = new Paragraph(new Phrase(lineSpacing,"\t\t\t 2)Under Section (80D to 80TTA/80TTB) Declaration", font));
				p.setAlignment(Element.ALIGN_LEFT);
				//p.setSpacingAfter(4);
				cell = new PdfPCell();
				cell.setBorder(PdfPCell.NO_BORDER);
				...
				//***************************************
				//********************************************
				p = new Paragraph(new Phrase(lineSpacing,"12)Qualifying Amount for Section (80D to 80TTA/80TTB)", font));
				p.setAlignment(Element.ALIGN_LEFT);
				//p.setSpacingAfter(4);
				cell = new PdfPCell();
				cell.setBorder(PdfPCell.NO_BORDER);
			...
			//	p = new Paragraph(new Phrase(lineSpacing, ""+formatter.format(Double.parseDouble(TaxSections.get(empid+"_Emp_Tax_E").toString()) -)+""   , font));
				...
				Double Total_Wit_Surcharge=Double.parseDouble(TaxSections.get(empid+"_Emp_Tax_E").toString())-Double.parseDouble(TaxSections.get(empid+"_SURCHARGE").toString());
				
				p = new Paragraph(new Phrase(lineSpacing, ""+formatter.format(Total_Wit_Surcharge)+""   , font));
				...
				Double Total_Wit_Surcharge1=Double.parseDouble(TaxSections.get(empid+"_ANN_Emp_Tax_E").toString())-Double.parseDouble(TaxSections.get(empid+"_ANN_SURCHARGE").toString());
			...
			//	p = new Paragraph(new Phrase(lineSpacing, ""+formatter.format(Double.parseDouble(TaxSections.get(empid+"_ANN_Emp_Tax_E").toString()))+"" , font));
				...
				p = new Paragraph(new Phrase(lineSpacing, ""+formatter.format(Total_Wit_Surcharge1)+"" , font));
				...
				p = new Paragraph(new Phrase(lineSpacing,"\t\t\t i)Add:Surcharge(with relief who have taxable income>50Lakhs)", font));
				p.setAlignment(Element.ALIGN_LEFT);
				//p.setSpacingAfter(4);
				cell = new PdfPCell();
				cell.setBorder(PdfPCell.NO_BORDER);
			...
			//	p = new Paragraph(new Phrase(lineSpacing,"\t\t\t ii)Add:Education cess", font));
				p = new Paragraph(new Phrase(lineSpacing,"\t\t\t ii)Add:Health and Education Cess", font));
				p.setAlignment(Element.ALIGN_LEFT);
				//p.setSpacingAfter(4);
				cell = new PdfPCell();
				cell.setBorder(PdfPCell.NO_BORDER);
