...
public class PayData_Temp_all extends HttpServlet {
	...
	//String FromPeriod="201609";
      ...
      // Azista BU
       ...
       // list_BU_la.add(26); 
        ...
        //list_BU_la.add(33); // added new
        //list_BU_la.add(34); // added new
	...
	/*if(EmpParam!=null){
		...
		Eq_emp_plan="EMPID";
		  ...
		  // Employee_ID_Seq_Bulk.append(" select employeeid,employeesequenceno,companyid from hclhrm_prod.tbl_employee_primary where employeesequenceno in("+Emp_Seq_Number+")  and status in(1001,1092,1401) ");
		   ...
		   // ADD For Final Caliculation VENU CURRPAYPERIOD 
			//currentPayperiod=201903;
