...
public class PayData_Temp_201921_BACKUP extends HttpServlet {
	...
	*/
	...
	//String FromPeriod="201609";
	   String FromPeriod="201904";
	   
	   String ToPeriod="202003";
	   
	  // String ToPeriod="201910";
	   
	   int currentPayperiod=202003; 
	   
	   int ClosedPayperiod=202003; 
	   
	   // need to change current payperiod every time every month
	   String TaxStartMonth="2019-04-01";
	   String TaxEndMonth="2020-03-31";
	...
	/*if(EmpParam!=null){
		...
		Eq_emp_plan="EMPID";
		    ...
		    if(companyid!=null && companyid.equalsIgnoreCase("10001")){
		    	...
		    	//Employee_ID_Seq_Bulk.append(" select employeeid,employeesequenceno,companyid from hclhrm_prod.tbl_employee_primary where employeesequenceno in("+Emp_Seq_Number+") and status in(1001,1092,1401) ");
		    	//** changed for remove employess list Data*/
		   Employee_ID_Seq_Bulk.append(" select employeeid,employeesequenceno,companyid from hclhrm_prod.tbl_employee_primary where employeesequenceno in("+Emp_Seq_Number+")  and status in(1001,1092,1401,1061) ");
