...
public class PayData_Temp_201920 extends HttpServlet {
	...
	*/
	...
	static final Logger LOGGER = Logger.getLogger(PayData_Temp_201920.class);
	...
	//String FromPeriod="201609";
	   String FromPeriod="202004";
	   
	   String ToPeriod="202103";
	   
	  // String ToPeriod="201910";
	   
	   int currentPayperiod=202103; 
	   
	   int ClosedPayperiod=202103; 
	   
	   // need to change current payperiod every time every month
	   String TaxStartMonth="2020-04-01";
	   String TaxEndMonth="2021-03-31";
  ...
  //2018-19    
      ...
      while(Bu_List_lat.hasNext()){   /// Main Bu Iterator opining For Bu Iteratero
    	  ...
    	  FromPeriod="202004";
    	  ToPeriod="202103";
    	  currentPayperiod=202103; 
    	  ClosedPayperiod=202103;  
	...
	/*if(EmpParam!=null){
		...
		Eq_emp_plan="EMPID";
		   ...
		   Employee_ID_Seq_Bulk.append(" select employeeid,employeesequenceno,companyid from hclhrm_prod.tbl_employee_primary where employeesequenceno in("+Emp_Seq_Number+") and status in(1001,1092,1401,1061,1161) ");
...
//							currentPayperiod=Integer.parseInt(rs.getString("prdcurrent")); //enable after one payroll
		    ...
		    //	Employee_ID_Seq_Bulk.append(" select employeeid,employeesequenceno from hclhrm_prod.tbl_employee_primary where companyid in("+companyid+")  and status in(1001,1092,1401)");
		   	...
		   	Employee_ID_Seq_Bulk.append(" select employeeid,employeesequenceno from hclhrm_prod.tbl_employee_primary where companyid in("+companyid+") and status in(1001,1092,1401,1061,1161) ");
