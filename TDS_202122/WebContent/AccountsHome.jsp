...
function Call_Ser(){
	...
	//alert(1);
	document.forms[0].action='Assam_health_report';
	document.forms[0].submit();
	
}
</script>
</head>
<!-- data-ng-init="empdetails();" Onload="Call_Ser();" -->
<body    ng-app="myApp" ng-controller="formCtrl" style='display:'>
